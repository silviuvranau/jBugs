...
HTTP Headers, such as `UserModel-Agent`, can be set in the `options` object.
In the example below, we call the github API to find out the number
of stars and forks for the request repository. This requires a
custom `UserModel-Agent` header as well as https.
...
UserModel-Agent: whatever user agent you specify
```
