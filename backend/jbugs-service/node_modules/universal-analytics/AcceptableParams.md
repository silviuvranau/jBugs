...
## UserModel Agent Override

Pass as: `userAgentOverride` or `ua`

Optional. The UserModel Agent of the browser. Note that Google has libraries to identify real user agents. Hand crafting your own agent could break at any time.
...
## UserModel timing variable name
