...
export class NewBugComponent implements OnInit {
  ...
  submitAddData(){
    ...
    if( currentUser == null){
      this.errorMessage = {id: "5001",type: "Current managers could not be retrieved", details:[{detail:"Current managers could not be retrieved",message:""}]};
      return;
    }
    ...
    if (assignedUser == null) {
      this.errorMessage = { id:"5002",type: "Can not find the assigned managers.",details:[{detail:"Can not find the assigned managers.",message:""}]};
      return;
    }
